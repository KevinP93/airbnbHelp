...
const i18n = {
  fr: { where:'Ou', when:'Quand', who:'Qui', infos:'Infos', around:'Autour', wifi:'Wi-Fi', ssid:'Nom (SSID):', password:'Mot de passe:', copy:'Copier le mot de passe', copied:'Copie !', showqr:'Afficher QR', hideqr:'Masquer QR', scanwifi:'Scannez pour vous connecter au Wi-Fi.', arrival:'Arrivee & Depart', checkin:'Check-in:', checkout:'Check-out:', house:'Maison • Ou trouver quoi ?', rules:'Regles et consignes', transport:'Transports', emergency:"Contacts d'urgence", reco:'Recommandations locales', restaurants:'Restaurants', activities:'Activités', updated:'Mis a jour:', itinerary:'Itineraire', viewmap:'Voir sur la carte' },
